...
<template>
  <div
    class="w-56 py-5 px-5 border rounded-lg border-neutral flex flex-col gap-2 hover:shadow-xl hover:cursor-pointer"
  >
    <img
      :src="product.image"
      alt="product's image"
      class="size-40 rounded-lg bg-contain mx-auto"
    />
    ...
    <div class="flex justify-between items-center">
      ...
      <button
        class="btn btn-outline btn-primary !min-h-0 h-fit py-1 rounded-full group"
